...
try:
    ...
    logging.debug("You have %d CPU cores, so the multiprocessing state is %s",
                  CPU_COUNT, MULTI_PROCESSING)
except ImportError:
    MULTI_PROCESSING = False
    logging.debug(
        "You don't have multiprocessing support for your Python version !")
...
class GPopulation(object):
    ...
    **Examples**
    ...
    def create(self, **args):
        ...
        self.internalPop = [self.oneSelfGenome.clone()
